...
<body>
	<t:navegacio/>
		<div id="mySidenav" class="sidenav">
		  ...
		  <a href="${pageContext.request.contextPath}/my/offers/add.html">MushMap</a>
          <a href="${pageContext.request.contextPath}/all/offers/list.html">Wettest areas</a>
          <a href="${pageContext.request.contextPath}/all/requests/list.html">Productive areas</a>
		  <a href="${pageContext.request.contextPath}/my/requests/add.html">Micology info</a>
		</div>
